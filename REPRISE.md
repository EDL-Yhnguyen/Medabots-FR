...
**Le patch français existe et fonctionne.** `patch/medabots-fr.bps` (5 880 octets)
traduit **286 entrées** : 64 objets, 34 médailles, 60 types d'attaque, 52
...
la place d'origine — 168 entrées à ce jour, il reste 44,8 Kio.
...
- **La police reste introuvable** après cinq méthodes statiques. L'indice du glyphe
  ...
  mGBA (installé).
- **Les accents ne s'affichent donc pas encore** : 208 remplacements signalés à
...
Ensuite, par ordre de valeur : les 128 libellés d'état (`0x3C4B90`), les 176
messages de combat (`0x3C6744`), puis les 480 Medaparts (`0x3BBB4C`).
